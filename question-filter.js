(()=>{
  ...
  window.fetch=async function(input,init){
    ...
    // 一対二・五六：参画と企画の2つを同時に答えさせる。
    const onePrompt='「一対二・五六」の内容について【①】【②】を答えてください。\n\n第一段階は、ある仕事やテーマに対してメンバーが自分なりの意見を述べたり、一部の役割を担ったりするという関わり方です。この状態を「【①】」と言います。自分が関わった仕事やテーマについては、人は高い関心を持つようになります。メンバーに仕事を「【①】」させることで、一のインプットに対して一・六くらいの成果が上がると考えます。\n\n第二段階は、ある仕事やテーマに対してメンバー自身が主体者となり、自ら目標を設定したり、達成方法を考えたりするという考え方です。この状態を「【②】」と言います。この場合は、一のインプットに対して一・六の二乗である二・五六の働きが期待できます。';
    if(!q.some(x=>x[0]===1&&x[2]===onePrompt)){
      q.push([1,'教訓',onePrompt,'①参画　②企画','原本メモでは、できるだけ多くの意見を引き出して仕事に参画してもらい、さらにメンバー自身に目標を立てて動いてもらう・企画してもらうことで「参画→企画」と進む。']);
    }
